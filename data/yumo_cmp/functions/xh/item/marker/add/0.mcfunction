...
#对比
##一样
execute if blocks 1 0 0 1 0 0 0 0 0 all at @s run function yumo_cmp:xh/item/marker/add/0_1

##不一样
##跳到下一个格子
execute unless blocks 1 0 0 1 0 0 0 0 0 all run function yumo_cmp:xh/item/marker/air/1
