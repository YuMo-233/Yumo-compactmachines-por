...
execute if blocks 1 0 0 1 0 0 0 0 0 all at @s run function yumo_cmp:xh/item/marker/add/1_1

execute unless blocks 1 0 0 1 0 0 0 0 0 all run function yumo_cmp:xh/item/marker/air/2
