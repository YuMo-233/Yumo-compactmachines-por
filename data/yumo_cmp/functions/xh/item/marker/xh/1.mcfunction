execute store result score item_xh yumo_cmp_item run data get entity @s data.yumo_cmp_Item_xh[1].Count 10000
execute store result score item_xh1 yumo_cmp_item run data get entity @s data.yumo_cmp_Item_xh[1].xh 10000
data modify entity @s data.yumo_cmp_Item_xh[1].Count set value 0
...
execute store result entity @s data.yumo_cmp_Item_xh[1].xh double 0.0001 run scoreboard players get item_xh yumo_cmp_item
