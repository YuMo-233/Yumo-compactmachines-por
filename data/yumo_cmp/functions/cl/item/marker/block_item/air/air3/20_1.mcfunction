...
data modify block ~ ~ ~ Items[20].id set from entity @s data.yumo_cmp_Item_cl[3].id
data modify block ~ ~ ~ Items[20].tag set from entity @s data.yumo_cmp_Item_cl[3].tag
...
execute if score item yumo_cmp_item matches 10000.. in yumo_cmp:yumo_cmp_load run function yumo_cmp:cl/item/marker/block_item/air/air3/20
