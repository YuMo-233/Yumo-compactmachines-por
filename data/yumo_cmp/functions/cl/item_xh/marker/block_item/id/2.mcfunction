...
execute if blocks 1 0 0 1 0 0 0 0 0 all at @s at @e[tag=yumo_cmp_clxh_marker,limit=1] run function yumo_cmp:cl/item_xh/marker/block_item/add/2

execute unless blocks 1 0 0 1 0 0 0 0 0 all run function yumo_cmp:cl/item_xh/marker/block_item/id/3
