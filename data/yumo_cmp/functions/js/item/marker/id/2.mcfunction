...
data modify block 1 0 0 Items[0].id set from entity @s data.yumo_cmp_Item_js[2].id
data modify block 1 0 0 Items[0].tag set from entity @s data.yumo_cmp_Item_js[2].tag

execute unless blocks 1 0 0 1 0 0 0 0 0 all run function yumo_cmp:js/item/marker/air/3

execute if blocks 1 0 0 1 0 0 0 0 0 all at @s run function yumo_cmp:js/item/marker/count/2
