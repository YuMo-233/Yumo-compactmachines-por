execute store result score item_cl yumo_cmp_item run data get entity @s data.yumo_cmp_Item_js[2].Count 10000
execute store result score item_cl1 yumo_cmp_item run data get entity @s data.yumo_cmp_Item_js[2].cl 10000
data modify entity @s data.yumo_cmp_Item_js[2].Count set value 0
...
execute store result entity @s data.yumo_cmp_Item_js[2].cl double 0.0001 run scoreboard players get item_cl yumo_cmp_item
